 ...
 * @version 1.3
 */
public class AdderOne extends OpenCOMComponent implements IUnknown, IAdd, IParallel, IMetaInterface, ILifeCycle {
    
    private String Owner;

    /** Creates a new instance of Adder */
    public AdderOne(IUnknown pRuntime) {
        super(pRuntime);
        Owner = "Paul Grace";
    ...
    public boolean startup(Object pIOCM) {
        ...
        //SetAttributeValue("AdderComponent.IParallel", "Interface", "Date", "Oct", Owner);
        return true;
    }
