...
public class SequentialReceptacle {
    ...
    public static void main(String[] args) {
        ...
        IUnknown pCalcIUnk = (IUnknown) pIOCM.createInstance("CalculatorComponent.CalculatorSequential", "Calculator");
        ...
        System.out.println(pICalc.display("MultiRecp -- Sequential Test"));
    }
