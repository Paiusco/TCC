...
public class PreAndPostMethods {
    ...
    public String encode(String word, int key){
     ...
     public int checkRules(String method, Object[] args){
        ...
        ppVals = pMeta.GetAllValues("Receptacle", "AdderComponent.IAdd");
        if(ppVals!=null){
            ...
            IDelegator pDel = pMetaIntc.GetDelegator(pAdder, "AdderComponent.IAdd");
